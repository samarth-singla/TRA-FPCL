...
*Last updated: March 6, 2026 (v3 — Splash screen removed, login cleaned up, RAE header fixed). Hand this file to a new chat to continue work.*
...
### 🟢 Low Priority / Polish
- **Offline sync** — no `sqflite` local cache; app requires internet
